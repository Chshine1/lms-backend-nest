...
export class Init1775292437034 implements MigrationInterface {
    name = 'Init1775292437034'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user_permissions" ("user_id" integer NOT NULL, "resource" smallint NOT NULL, "action" smallint NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, CONSTRAINT "PK_a1e959e9afe42de391981c1f20e" PRIMARY KEY ("user_id", "resource", "action"))`);
